...
local Window = Rayfield:CreateWindow({
	Name = "Blox Fruits - zPaew Ultra",
	LoadingTitle = "Blox Fruits - zPaew Ultra",
	LoadingSubtitle = "Subscribe to zPaew on YouTube!",
})
...
local Label = Tab:CreateLabel("Thanks for using zPaew Ultra!")
local Label = TabUtil:CreateLabel("Thanks for using zPaew Ultra!")
local Label = TabOther:CreateLabel("Thanks for using zPaew Ultra!")
local Label = TabMobile:CreateLabel("Thanks for using zPaew Ultra!")



local Button = Tab:CreateButton({
	Name = "Sonic Hub (bunu kulan)",
	Callback = function()
